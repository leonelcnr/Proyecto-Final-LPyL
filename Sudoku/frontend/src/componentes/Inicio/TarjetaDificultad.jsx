    ...
    return (
        ...
        group">
            ...
            <div className=" flex flex-col gap-2 justify-around items-center text-center h-1/2">
                ...
                <button className="w-40 h-12 text-blue-400 flex items-center justify-center rounded-md bg-transparent border-2 relative border-blue-600 transition-all duration-300
                hover:-translate-y-2
